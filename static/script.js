...
window.googleLT_ || (window.googleLT_ = new Date().getTime()),
   ...
   window.google.loader ||
      ...
      (function () {
         ...
         function c() {
            j[document.readyState]
               ? u()
               : 0 < w.length && window.setTimeout(c, 10);
         }
         function u() {
         ...
         (google.loader.eval = {}),
            ...
            (google.load = function (t, i, n) {
               ...
               if (
                  ...
                  throw e(
                     "Module: '" + r + "' must be loaded before DOM onLoad!"
                  );
               o
                  ? t.u(i, n)
         ...
         (google.loader.f = function (t, i, n) {
            ...
            (google.loader.a.K =
               "//www.google.com/cse/style/look/bubblegum.css"),
            p(google.loader.a, "BUBBLEGUM", google.loader.a.K),
            (google.loader.a.M =
               "//www.google.com/cse/style/look/greensky.css"),
            p(google.loader.a, "GREENSKY", google.loader.a.M),
            (google.loader.a.L =
               "//www.google.com/cse/style/look/espresso.css"),
            ...
            (google.loader.a.N =
               "//www.google.com/cse/style/look/minimalist.css"),
            ...
            (a.prototype.i = function (t, i) {
               ...
               if (
                  (void 0 != i &&
                     ...
                     void 0 != i.nocss &&
                        (n +=
                           "&output=" + encodeURIComponent("nocss=" + i.nocss)),
                     void 0 != i.nooldnames &&
                        (n +=
                           "&nooldnames=" + encodeURIComponent(i.nooldnames)),
                     void 0 != i.packages &&
            ...
            (a.prototype.load = function (t, i) {
               ...
               if (n.length) {
                  for (
                     i && i.packages && (i.packages = n.sort().join(",")),
                        o = 0;
                     o < r.length;
                     o++
                  )
                  ...
                  if (
                     ...
                     (i && i.autoloaded) ||
                        google.loader.f("script", this.i(t, i), e);
                  else {
                     (n = m[":" + this.b]),
            ...
            (d.prototype.load = function (t, i) {
               ...
               n
                  ...
                  : (this.j = !0),
                  (i && i.autoloaded) ||
                     google.loader.f("script", this.i(t, i), n);
            }),
                     ...
                     t.params[s]
                        ...
                        : "base_domain" == s &&
                          (i =
                             "https://" +
                             n[s] +
                             t.uri.substring(t.uri.indexOf("/", 7)));
               return (
                  (google[this.name] = {}),
      ...
      !(function () {
         ...
         function nt(t) {
            ...
            return t[_a](mk, function (t, s) {
               ...
               return (
                  r || (n(e, t + eb), (r = e[Lf][Zd][Ga](0, -1))), (i[t] = r)
               );
            });
         }
         function et(t) {
         ...
         function zt() {
            return (
               nx[9] || (nx[9] = Pk && La.documentMode && La.documentMode >= 9)
            );
         }
         function Ut(t, i) {
            var n = 0,
         ...
         function Kt(t) {
            var i = t[xd] || t[bd],
               n = i.selection[pf]();
            return (
               t[Pf] == yy ? ((i = i[kd][yf]()), i[wd](t)) : (i = t[yf]()),
               [i, n]
            );
         }
         function Gt(t, i) {
         ...
         function zi(t) {
            ...
            return (
               ...
               n.top >= 0 && n[vf] >= 0 && n[Dd] > n.top && n[$d] > n[vf]
                  ? n
                  : wa
            );
         }
            ...
            if (!e.jf && e.yh) {
               ...
               m(e, r),
                  ...
                  0 == r &&
                     ...
                     Bx[t][i].G--,
                     0 == Bx[t][i].G &&
                        (xx(Bx[t][i]), delete Bx[t][i], Bx[t].G--),
         ...
         function me(t, i) {
            ie[Ad](this),
               ...
               (this.j = new se(this)),
               (this.F =
                  this.b && this.b.getAttribute && !!this.b.getAttribute(hm)),
               (this.d = {}),
               (this.p = {}),
               (this.rb = 0);
         }
         ...
         function De(t) {
            ...
            if (3 == t[Ja]) i[sd](t, 0), i[ff](t, t[rd]);
               ...
               (n = t[Gd]), (t = kk(n[zf], t)), i[sd](n, t), i[ff](n, t + 1);
            return i;
         }
         function He(t, i, n, e) {
            var s = vi(t)[pf]();
         ...
         function ys(t, i) {
            if (js(t)) {
               for (
                  var n = i ? Yw : yj, e = i ? yj : Yw, s = [t[Zd]];
                  js(t[n]);
            ...
            return (
               ...
               function () {
                  return (
                     !i.k &&
                        e &&
                        ((i.k = e[Vf]), i.k || (i = new Ls(e, ws(e)))),
                     !s.k &&
                        o &&
                        ((s.k = o[Vf]), s.k || (s = new Ls(o, ws(o)))),
         ...
         function Vs(t, i, n, e, s) {
            for (
               this.j = t, this.c = i, this.b = {}, t = 0, i = n[rd];
               i > t;
               t++
            )
               this.b[n[Qa](t)] = !0;
         ...
         function dr(t) {
            return (
               (t = t[Bd](0)), gb + ((t >> 4) & 15)[nd](16) + (15 & t)[nd](16)
            );
         }
         function br(t, i, n) {
            ...
            xk(
               ...
               function (t) {
                  ...
                  e &&
                     (bt(e, this),
                     0 == e[rd] &&
                        (i.f.sj(t, t), i.j.Ca(i.f, n, i), delete i.d[n]));
               },
               t
            );
         }
         ...
         function Xo(i, n) {
            if (i.Rb) {
               ...
               var r = Yo(i);
               s &&
                  ((i.td = e), Qo(i, !1), (i.td = n), Ar(Zo(i), r), Qo(i, !0));
            } else
               t(
                  Ta(
         ...
         function Yh(t) {
            ...
            var n = MS[t];
            return (
               n && (i = n[1] = n[0][Qa]((n[0][cf](n[1]) + 1) % n[rd])), i || t
            );
         }
         function Xh(t, i) {
         ...
         function xc(t, i, n) {
            var e = i;
            return (
               O(i) && n && (e = new $h(i, n)), e && e.Xb ? e : wc(t, e, t.z)
            );
         }
         function Tc(t, i) {
         ...
         function lu(t, i) {
            var n =
                  i ||
                  new ou({ Vd: Tv, N: !0, yg: zv, zg: wm, Jf: 5, Jd: 100 }),
               e = new eo(),
               s = new yc(t, new Nc({ kb: n.kb, ad: 5 })),
               r = new yc(
                  t,
                  new Nc({ kb: n.kb, ad: 10, Dd: 40, zc: 50 }),
                  !0,
                  uu
               ),
               o = new yc(
                  t,
                  new Nc({ kb: n.kb, ad: 18, Dd: 90, zc: 198 }),
                  !0,
                  uu
               ),
               h = fu(),
         ...
         var va,
            ...
            rw =
               "inputapi-transliterate-img inputapi-transliterate-img-button-",
            ow =
               "inputapi-transliterate-img inputapi-transliterate-img-langmenu-",
            ...
            ik = "Ãƒâ€šÃ‚Â¥",
            nk =
               "Ãƒâ€žÃ¢â‚¬ Ãƒâ€žÃ¢â‚¬Â¡Ãƒâ€žÃ…â€™Ãƒâ€žÃ‚ÂÃƒâ€žÃ‚ÂÃƒâ€žÃ¢â‚¬ËœÃƒâ€¦ Ãƒâ€¦Ã‚Â¡Ãƒâ€¦Ã‚Â½Ãƒâ€¦Ã‚Â¾",
            ek = "ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â¹",
         ...
         var dk = /^[a-zA-Z0-9\-_.!~*'()]*$/,
            ...
            kk = yk[cf]
               ...
               : function (t, i, n) {
                    if (
                       ((n = n == wa ? 0 : 0 > n ? Ra.max(0, t[rd] + n) : n),
                       O(t))
                    )
            ...
            xk = yk[If]
               ...
               : function (t, i, n) {
                    for (
                       var e = t[rd], s = O(t) ? t[vd](tb) : t, r = 0;
                       e > r;
                       r++
                    )
         ...
         (Vt[cd].W = function () {
            ...
            (va.ceil = function () {
               return (
                  i(this, Ra[Wa](this[za])), T(this, Ra[Wa](this[Vd])), this
               );
            }),
            (va.floor = function () {
               return (
                  i(this, Ra[Ya](this[za])), T(this, Ra[Ya](this[Vd])), this
               );
            }),
            (va.round = function () {
               return (
                  i(this, Ra.round(this[za])), T(this, Ra.round(this[Vd])), this
               );
            });
         var ex = !Pk || zt();
         ...
         (hn[cd].Oe = !1),
            ...
            (yn[cd].b = function (t, i, n, e) {
               ...
               ln(
                  ...
                  t,
                  i,
                  new Vt(this.c.x + s[Rd], this.c.y + s[$f]),
                  n,
                  wa,
                  e
               );
            ...
            (va.Li = function () {
               if (this.d) {
                  ...
                  t > 0 && t < 0.8 * this.c
                     ...
                     : (Jn(this, Ty),
                       this.d &&
                          ((this.Dc = this.b[dd](this.f, this.c)),
                          (this.j = fk())));
               }
            }),
            (va.start = function () {
         ...
         (va = me[cd]),
            ...
            (va.Ca = function (t, i) {
               ...
               n &&
                  (bt(n, i),
                  0 == n[rd] &&
                     (this.j.Ca(this.dc(), t, this), delete this.d[t]));
            }),
            d(va, function (t) {
            ...
            (va.Ch = function (t) {
               ...
               if (_t(n)) n.selectionStart = t;
                  ...
                  var e = Kt(n),
                     s = e[0];
                  s[Va](e[1]) &&
                     ((t = Gt(n, t)), s[Ka](!0), s[hf](fv, t), s[qf]());
               }
               (n = this.b),
                  _t(n)
                     ? (n.selectionEnd = i)
            ...
            (va.splice = function (t) {
               ...
               this.cb == n &&
                  ...
                  (this.b = !this.b);
               for (
                  var n = F(arguments[0]) ? arguments[0] : arguments,
                     e = n[rd] - 1;
                  e >= 0;
                  e--
               )
            ...
            (va.Zd = function () {
               return (
                  this.Qf && this.k == this.Db && (!this.ud || 1 != this.cb)
               );
            }),
            j(va, function () {
            ...
            (va.pg = function () {
               if (!this.xb) {
                  ...
                  for (
                     ...
                     1 == n[zf][rd] &&
                     n.innerText ==
                        (3 == n[Lf][Ja] ? n[Lf][Zd] : n[Lf].innerText) &&
                     Ye(n[Lf]);
            ...
            (us[cd].d = function () {
               for (
                  var t = (this.b[rd] ? vi(this.b[0]) : La)[
                        kd
                     ].createControlRange(),
                     i = 0,
                     n = this.b[rd];
            ...
            (va.bc = function (t) {
               return (
                  this.c[t] || (this.c[t] = Qe(Je(this.b[t]), ma)), this.c[t]
               );
            }),
            (va.Nc = function () {
               if (!this.f) {
         ...
         It(Sg, Tg, "EMBED"),
            ...
            (va.Kf = function () {
               if (!this.j) {
                  if (
                     (this.c || (this.c = this.yc = ek), this.Sa() || this.xc())
                  ) {
                     var t = this.H,
                        i = this.V,
                        n = i.k,
         ...
         var gT =
            "`'-_~!@#$%^&*()+=[]\\{}|;:\",./<>?ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã‹Å“ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã…Â½ 	\r\n" +
            Aa[Tf](160);
         ...
         var pT = new Vs(
               "Ethi",
               [{ start: "ÃƒÂ¡Ã‹â€ Ã¢â€šÂ¬", end: "ÃƒÂ¡Ã‚ÂÃ‚Â¿" }],
               "ÃƒÂ¡Ã‚Â ÃƒÂ¡Ã‚ÂÃ‚Â¡ÃƒÂ¡Ã‚ÂÃ‚Â¢ÃƒÂ¡Ã‚ÂÃ‚Â£ÃƒÂ¡Ã‚ÂÃ‚Â¤ÃƒÂ¡Ã‚ÂÃ‚Â¥ÃƒÂ¡Ã‚ÂÃ‚Â¦ÃƒÂ¡Ã‚ÂÃ‚Â§ÃƒÂ¡Ã‚ÂÃ‚Â¨" +
                  gT,
         ...
         var xT,
            TT = new Vs(
               "Beng",
               [
                  { start: "Ãƒ Ã‚Â¦Ã¢â€šÂ¬", end: "Ãƒ Ã‚Â§Ã‚Â¿" },
                  { start: "ÃƒÂ¢Ã¢â€šÂ¬Ã…â€™", end: "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" },
               ],
               gT,
               { fontSize: 16, lineHeight: 1.8, Ra: 28 }
            );
         ...
         var IT,
            NT = new Vs(
               "Gujr",
               [{ start: "Ãƒ Ã‚ÂªÃ¢â€šÂ¬", end: "Ãƒ Ã‚Â«Ã‚Â¿" }],
               gT,
               { fontSize: 16, lineHeight: 1.8, Ra: 28 }
            );
         ...
         var FT,
            OT = new Vs(
               "Jpan",
               [
                  { start: "ÃƒÂ£Ã‚ÂÃ¢â€šÂ¬", end: "ÃƒÂ£Ã¢â‚¬Å¡Ã…Â¸" },
                  { start: "ÃƒÂ£Ã¢â‚¬Å¡ ", end: "ÃƒÂ£Ã†â€™Ã‚Â¿" },
                  { start: "ÃƒÂ£Ã‚ÂÃ¢â€šÂ¬", end: "ÃƒÂ©Ã‚Â¿Ã‚Â¿" },
               ],
               tb
            );
         ...
         var zT,
            UT = new Vs(
               "Mlym",
               [
                  { start: "Ãƒ Ã‚Â´Ã¢â€šÂ¬", end: "Ãƒ Ã‚ÂµÃ‚Â¿" },
                  { start: "ÃƒÂ¢Ã¢â€šÂ¬Ã…â€™", end: "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â" },
               ],
               gT,
               { fontSize: 16, lineHeight: 1.8, Ra: 28 }
            ...
            (va.mg = function (i, n, e) {
               if (
                  ...
                  var s = this.Sb,
                     r = i.Fa();
                  r in s &&
                     t(Ta('The object already contains the key "' + r + ub)),
                     (s[r] = i);
               }
               Or(i, this),
                  vt(this.Ja, n, 0, i),
         ...
         (IS[NS] = go),
            ...
            (va.removeChild = function (t, i) {
               if ((t = O(t) ? Ur(this, t) : t)) {
                  var n = _r(this, t);
                  -1 != n &&
                     (n == this.Ba ? xo(t, !1) : n < this.Ba && this.Ba--),
            ...
            (va.Cj = function (t) {
               (t = t[Sd].sd || wa),
                  this.j && (this.j(t != wa, t), (this.j = wa));
            }),
            (va.Rc = function (t) {
               ah.g.Rc[Ad](this, t),
         ...
         (va = bh[cd]),
            ...
            (va.Fi = function (t) {
               if (this.Pf) {
                  ...
                  (n = ph(this, i, n)),
                     ...
                     (n = n.y),
                     this.ec &&
                        $n(this, new jh(_p, this, t[Wf], t[Yf], t, i, n)) !==
                           !1 &&
                        (vh(this, t, i, n), t[ef]());
               }
            }),
            ...
            (va.bd = function (t) {
               ...
               if (46 == t[Cf])
                  return (
                     this.b < this.c[zf][rd] - 1 && Nh(this, this.b + 1), !0
                  );
               ...
               switch (t[Cf]) {
                  ...
                  case 36:
                     return (
                        this.Da(ft(this.O()[vd](tb), this.d.fd, this.d)), !0
                     );
                  case 35:
                     return this.Da(!1), !0;
                  case 33:
         ...
         (va = Hh[cd]),
            ...
            (va.forEach = function (t, i) {
               for (var n in this.b)
                  this.b[jd](n) &&
                     t[Ad](i, 32 == n[Bd](0) ? n[Zf](1) : n, ma, this);
            }),
            (va.yb = function () {
               var t,
                  i = [];
         ...
         var HS,
            FS = { ".": "ÃƒÂ¡Ã‚ÂÃ‚Â¢", ",": "ÃƒÂ¡Ã‚ÂÃ‚Â£" },
            OS = { ",": "ÃƒËœÃ…â€™", ";": "ÃƒËœÃ¢â‚¬Âº", "?": "ÃƒËœÃ…Â¸" },
            PS = {
               ".": "ÃƒÂ£Ã¢â€šÂ¬Ã¢â‚¬Å¡",
               "~": "ÃƒÂ¯Ã‚Â½Ã…Â¾",
               "!": "ÃƒÂ¯Ã‚Â¼Ã‚Â",
                        ...
                        switch (((s = this.j[e]), i[Pf])) {
                           case kw:
                              zk &&
                                 ...
                                 ((s.lastKey = -1), a(s, -1)),
                                 xS &&
                                 !he(i[Cf], s.lastKey, i[Md], i[pd], i[ed])
                                    ? (s = Ir(i, s))
                                    : (a(
                                         s,
                                         Mk && i[Cf] in kS ? kS[i[Cf]] : i[Cf]
                                      ),
                                      (s = wa));
                              break t;
                           case Tw:
            ...
            (va.dh = function (i, n) {
               ...
               if ((h != e.c && ((e.d = new wr(o, e.f)), (e.c = h)), r)) {
                  (o = Rt(r)),
                     ...
                     (h = Nt(r)),
                     o[rd] != h[rd] &&
                        t(Ta("Mismatched lengths for keys/values"));
               ...
               if (
                  ...
                  var d = La[Af](Hj),
                     b = wa;
                  if (
                     (o.Fd > 0 && (b = ck[dd](jr(a, d, r, u), o.Fd)),
                     (u = o.c.W()),
                     r)
                  )
                     for (f in r) (!r[jd] || r[jd](f)) && hr(u, f, r[f]);
                  h &&
                     ((ck._callbacks_[a] = yr(a, d, h, b)), hr(u, o.b, wp + a)),
         ...
         (va = Lc[cd]),
               ...
               if ((i = Uc(this)))
                  t: if (this.d.Le(this, t))
                     ...
                     if (dt(this.d.c, t[Cf])) {
                        ...
                        if ((n = i))
                           if (
                              ((n = this.Nb().D()), this.z && 0 != this.z[rd])
                           ) {
                              var e = ct(this.z);
            ...
            (va.Nb = function () {
               return (
                  this.c[Lf] != this.c[Ed] && Ts(this.c[Lf]), ps(Ai(this.C()))
               );
            }),
            (va.Da = function (t) {
                  ...
                  if (n && 0 != n[rd] && n[0]) {
                     ...
                     (ne(this.c, this.b).yd = e.q()),
                        n[Yd](tb)[rd] > this.d.Bf
                           ? (i.If(qg), (i = !1))
                           : ((i = this.M.Ad(e, V(this.oi, this, i))),
                             (i = P(i)));
                  } else i = !1;
               } else i = !1;
               return i;
         ...
         Y(gu, Th),
            ...
            (va.Rd = function (t) {
               ...
               if (
                  t != i &&
                  (i && (this.Y(!1), this.K && wu(this, i, !1), delete this.b),
                  t)
               ) {
            ...
            (va.Y = function (t, i) {
               if ((vu.g.Y[Ad](this, t), this.b && !!(64 & this.U) == t)) {
                  if (t)
                     this.b.K ||
                        (this.ii ? Pr(this.b, this.h()[Gd]) : Pr(this.b, ma)),
                        (this.f = zi(this.h())),
                        (this.d = Wi(this.h())),
                        this.Gf(),
                        th(this.b, -1);
            ...
            (va.Y = function (t, i) {
               ta.g.Y[Ad](this, t, i),
                  64 & this.U &&
                     th(
                        mu(this),
                        this.r && this.r.$a ? kk(this.r.b, this.r.$a) : -1
                     );
            }),
